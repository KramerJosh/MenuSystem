def place_order(menu):
    ...
    while True:
        ...
        # TODO: Extract the food category and the options for each category
            ...
            for meal, price in category_options.items():
        ...
        try:
            menu_selection =  int(input("Enter the number for you order: "))
            ...
            print(f"{menu_selection} is not a valid entry, please enter a number.")
            continue
...
def update_order(order, menu_selection, menu_items):
    ...
    if isinstance(menu_selection, int):
        ...
        if menu_selection in menu_items:
            ...
            try: 
             ...
             # using ValueError instead of conditional
            except ValueError:
                quantity = 1
    ...
    # TODO: Tell the customer they didn't select a menu option
        ...
        print(f"Invalid Selection: {menu_selection}.  Please select a menu item.")
